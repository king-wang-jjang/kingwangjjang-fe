...
고정폭 글꼴, 본문 13–14px, 페이지 제목 18–20px, 섹션 제목 17–18px를 사용한다. 제목은 굵기 800과 ASCII `=` 구분선으로 강조한다. 최대 폭 960px의 문서와 모바일 좌우 16px 여백을 기준으로 한다. 무채색 밝은/어두운 테마를 제공하고, 강조는 굵기·형광펜·대괄호로 나타낸다. 선택한 인기글 제목과 정렬 기준에는 형광펜 표시가 유지되며, 키보드 포커스 윤곽선도 보존한다.
