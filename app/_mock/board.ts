...
export const POSTITEMS: RealtimePaginationQuery['realtimePagination'] = [
  ...
  },
  {
    ...
    GPTAnswer: "React component lifecycle methods allow you to run code at particular times in a component's existence.",
  },
  {
    __typename: "RealTime",
    boardId: "3",
  ...
  },
  {
    ...
    GPTAnswer: "Optimizing web performance involves improving loading speed, reducing resource consumption, and enhancing the user experience.",
  },
  {
    __typename: "RealTime",
    boardId: "5",
