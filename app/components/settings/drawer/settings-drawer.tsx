...
import COLORS from '@/app/theme/core/colors.json';
import { paper, varAlpha } from '@/app/theme/styles';
import { defaultFont } from '@/app/theme/core/typography';
import PRIMARY_COLOR from '@/app/theme/with-settings/primary-color.json';
