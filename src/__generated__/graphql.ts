...
export type RealtimePaginationQuery = { __typename?: 'Query', realtimePagination: Array<{ __typename?: 'Realtime', Id?: string | null, category: string, no: number, site: string, title: string, url: string, contents?: string | null, gptAnswer?: string | null, createTime: any, thumbnail?: string | null }> };
