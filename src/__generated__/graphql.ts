...
export type CreateCommentMutation = { __typename?: 'Mutation', createComment: { __typename?: 'CommentEntry', Id: string, boardId: string, parentId?: string | null, content: string, userId: string, userNickname?: string | null, likeCount: number, replyCount: number, isDeleted: boolean, createdAt: any, updatedAt: any } };
