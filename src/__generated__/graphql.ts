...
export type RealtimePaginationQuery = { __typename?: 'Query', realtimePagination: Array<{ __typename?: 'Realtime', Id?: string | null, category: string, no: number, site: string, title: string, url: string, gptAnswer?: string | null, createTime: any, thumbnail?: string | null, commentCount?: number | null, likeCount?: number | null }> };
...
export type CreateCommentMutation = { __typename?: 'Mutation', createComment: { __typename?: 'CommentEntry', Id: string, boardId: string, parentId?: string | null, content: string, userId: string, userNickname?: string | null, likeCount: number, replyCount: number, isLiked: boolean, isDeleted: boolean, createdAt: any, updatedAt: any } };
...
export type CommentsQuery = { __typename?: 'Query', comments: { __typename?: 'CommentList', boardId: string, totalCount: number, comments: Array<{ __typename?: 'CommentEntry', Id: string, boardId: string, parentId?: string | null, content: string, userId: string, userNickname?: string | null, likeCount: number, replyCount: number, isLiked: boolean, isDeleted: boolean, createdAt: any, updatedAt: any }> } };
